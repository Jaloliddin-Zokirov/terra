    ...
    <section className="py-10">
      <div className="container">
        ...
        <div className="flex-col xl:flex xl:flex-row gap-4 items-start justify-between">
          ...
          <div>
            <div className="flex sm:flex-row flex-col items-center sm:items-start justify-between gap-4 mb-6">
              <div className="flex flex-col sm:gap-1 gap-4">
                <p className="text-[20px] flex items-center font-semibold text-white">
                  AED {car?.price_in_aed_sale}{" "}
                  <span className="text-[#8C9498] text-[20px]">
                    {" "}
                    / ${car?.price_in_aed}
                  </span>
                </p>
                <span className="block text-[#8A8892]">
                  {lang === "eng" ? "per day" : "в день"}
                </span>
                <p className="text-[18px] font-semibold line-through text-white">
                  AED {car?.price_in_usd_sale}{" "}
                  <span className="text-[#8C9498]">
                    {" "}
                    / ${car?.price_in_usd}
                  </span>
                </p>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-6">
                  <p className="w-[24%] text-[#8A8E92] text-[13px] font-semibold">
                    {lang === "eng" ? "Deposit" : "Залог"}
                  </p>
                  <p className="w-[76%] flex flex-col gap-1 text-[18px] font-semibold text-white">
                    AED {car?.deposit}
                    <span className="text-[#8A8E92] text-[14px] font-semibold">
                      {lang === "eng"
                        ? "AED 5000 for credit cards payment"
                        : "AED 5000 при оплате картами"}
                    </span>
                  </p>
                </div>
                <div className="flex items-center gap-6">
                  <p className="w-[24%] text-[#8A8E92] text-[13px] font-semibold">
                    {lang === "eng" ? "Premium protection" : "Премиум защита"}
                  </p>
                  <p className="w-[76%] flex flex-col gap-1 text-[18px] font-semibold text-white">
                    ...
                    <span className="text-[#8A8E92] text-[14px] font-semibold">
                      {lang === "eng"
                        ...
                        : "AED 5000 за цену за 1 день"}
                    </span>
                  </p>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-6 w-full xl:w-[580px]">
              ...
              <ul className="grid grid-cols-5 gap-5">
                <li className="flex flex-col items-center justify-center gap-1">
                  ...
                  <h5 className="text-white text-center">{car?.year}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="25"
                  ...
                  <h5 className="text-white text-center">{car?.seconds}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="21"
                  ...
                  <h5 className="text-white text-center">{car?.max_speed}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="14"
                  ...
                  <h5 className="text-white text-center">{car?.max_people}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="17"
                  ...
                  <h5 className="text-white text-center">{car?.color}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="24"
                  ...
                  <h5 className="text-white text-center">{car?.motor}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="19"
                ...
                <li className="flex flex-col items-center justify-center gap-1">
                  ...
                  <h5 className="text-white text-center">{car?.drive_side}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="20"
                  ...
                  <h5 className="text-white text-center">{car?.petrol}</h5>
                </li>
                <li className="flex flex-col items-center justify-center gap-1">
                  <svg
                    width="27"
                  ...
                  <h5 className="text-white text-center">
                    {lang === "eng" ? "Nissan Cars" : "Nissan Машины"}
                  </h5>
                </li>
              </ul>
              <div className="border border-white w-full"></div>
            ...
            <div className="tg-con flex gap-3 w-full justify-center my-[30px]">
              <button className="w-[75px] h-[65px] bg-[#5AEC5A] text-white text-[35px] rounded-2xl flex justify-center items-center">
                <a href="">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <button className="w-[75px] h-[65px] bg-[#2374F8] text-white text-[35px] rounded-2xl flex justify-center items-center">
                <a href="http://t.me/khamidulla441">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
              ...
              <button className="w-[75px] h-[65px] bg-[#FFB630] text-white text-[35px] rounded-2xl flex justify-center items-center">
            ...
            <form
              method="POST"
              className="border border-white p-[30px] flex flex-col gap-5 max-w-[400px] w-full mx-auto"
            >
              <h1 className="text-white">Chiron / White</h1>
              <input
                required=""
                className="w-full bg-white px-3 py-5"
              ...
              <input
                required=""
                className="w-full bg-white px-3 py-5"
                placeholder={lang === "eng" ? "Phone" : "Телефон"}
                type="number"
              />
              <input
                required=""
                className="w-full bg-white px-3 py-5"
                placeholder={lang === "eng" ? "Period" : "Период"}
                type="number"
              />
              <input
                required=""
                className="w-full bg-white px-3 py-5"
                placeholder={lang === "eng" ? "Detailes" : "Детали"}
                type="text"
              />
              <button
                type="submit"
                className="btn__send w-[150px] bg-orange-600 p-3 font-semibold text-[20px] rounded-[2px]"
              >
                {lang === "eng" ? "Send" : "Отправить"}
              </button>
            </form>
            <div className="text text-[#a4a4a4] mt-8 mx-[20px] text-center md:text-start flex flex-col gap-1">
              <p>
                {lang === "eng"
                  ? "The price doesn't include additional 5% VAT."
                  : "Цена не включает дополнительные 5% НДС."}
              </p>
              <p>
                {lang === "eng"
                  ? "There is a 3% transaction fee when paying by credit/debit card."
                  : "При оплате кредитной/дебетовой картой взимается комиссия 3%."}
              </p>
              <p>
                {lang === "eng"
                  ? "There is a 7% transaction fee when paying with American Express."
                  : "При оплате картой American Express взимается комиссия 7%."}
              </p>
            </div>
          </div>
        </div>
        <div>
          <h2 className="text-white text-[32px] font-semibold mt-[50px] mb-[25px] mx-[10px] text-center md:text-start">
            {lang === "eng" ? "SIMILAR OFFERS" : "ЕЩЕ ПОХОЖИЕ"}
          </h2>
          <CarCard cars={cars} />
        </div>
      </div>
